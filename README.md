...
<body>
  ...
  <main class="max-w-6xl mx-auto px-5 lg:px-8 py-12 md:py-20">
    ...
    <section id="page-marieb" class="page-section">
      <div class="max-w-3xl mb-12"><p class="eyebrow mb-3">Research</p><h1 class="text-4xl md:text-5xl font-bold mb-4">Elaine Marieb Center</h1><p class="text-lg text-[#5d6873]">Designing and prototyping engineering solutions for hospital settings alongside graduate students and registered nurses.</p></div>
      <article class="card overflow-hidden"><div class="grid md:grid-cols-2"><div class="placeholder min-h-[330px]"><!-- Add research / prototype photos here --><div><i class="fa-regular fa-image text-3xl mb-2"></i><p class="text-sm">Prototype or poster-session photo</p></div></div><div class="p-7 md:p-10"><p class="eyebrow">Summer 2023 – Summer 2025</p><h2 class="text-2xl font-bold mt-2 mb-4">Summer Research Assistant</h2><p class="text-[#5d6873] leading-relaxed mb-7">Used SOLIDWORKS, FDM printers, Python, and circuit design to build tools for robotics and healthcare research. Presented work at annual campus-wide poster sessions.</p><div class="space-y-5"><div><h3 class="font-bold">2025 · Dexterity testing board</h3><p class="text-sm text-[#5d6873] mt-1">Created a board for simulated nursing tasks such as peeling bandages and recapping syringes. The work supports research into effective grippers for bimanual imitation learning.</p></div><div><h3 class="font-bold">2024 · 3D scanner</h3><p class="text-sm text-[#5d6873] mt-1">Designed and manufactured a scanner that generated a digital object library for virtual robot training with ROS.</p></div><div><h3 class="font-bold">2023 · Hospital robot gripper</h3><p class="text-sm text-[#5d6873] mt-1">Worked toward a gripper intended to reduce nurses' workloads while maintaining safety and efficiency.</p></div></div></div></div></article>
    </section>
