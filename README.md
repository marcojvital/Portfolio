...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .timeline-year-label { position:relative; z-index:1; padding-right:1rem; text-align:right; font:700 2.25rem/1 'Space Grotesk',sans-serif; color:var(--ink); }
    .timeline-year-label::after { content:""; position:absolute; top:.35rem; right:-.58rem; width:1rem; height:1rem; border:3px solid var(--paper); border-radius:50%; background:var(--orange); box-shadow:0 0 0 1px var(--orange); }
    .timeline-seasons { display:grid; gap:.75rem; padding-bottom:.75rem; }
    .timeline-season-row { display:grid; grid-template-columns:5.5rem minmax(0,1fr); gap:1.25rem; align-items:start; min-height:6.5rem; }
    .timeline-season-label { padding-top:1.25rem; color:var(--muted); font-size:.78rem; font-weight:700; letter-spacing:.08em; text-transform:uppercase; }
    ...
    @media (max-width:700px) {
      ...
      .timeline-year-group { grid-template-columns:2rem minmax(0,1fr); column-gap:1rem; padding:1.25rem 0 .5rem; }
      .timeline-year-label { padding:0; text-align:left; writing-mode:vertical-rl; transform:rotate(180deg); font-size:1.5rem; }
      .timeline-year-label::after { top:.1rem; right:auto; left:.52rem; }
      .timeline-season-row { grid-template-columns:4.25rem minmax(0,1fr); gap:.75rem; min-height:0; }
      .timeline-season-label { padding-top:1rem; font-size:.66rem; }
